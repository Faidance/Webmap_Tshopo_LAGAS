...
map.getView().fit([2476555.050200, -235158.219114, 3134140.977100, 266826.967748], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte web Tshopo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (119 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Une cartographie  interactive des secteurs d\'activités dans la province de la Tshopo et de la superficie par territoire';
            }
